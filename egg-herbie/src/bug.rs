use egg::*;
use crate::{ConstantFold, Math, IterData};
...
fn repro() {
    let strs = vec![
        "(* (/ $h0 (+ (* $h0 -841/108) 4/29)) (* $h0 -707281/11664))",
        "(/ $h0 (+ (* $h0 -841/108) 4/29))",
        "$h0",
        "(+ (* $h0 -841/108) 4/29)",
        "-841/108",
        ...
        "(* 841/108 $h0)",
        "841/108",
        "(+ (* $h0 (* -707281/11664 (/ $h0 (+ (* $h0 -841/108) 4/29)))) 4/29)",
        "$h0",
        "(* -707281/11664 (/ $h0 (+ (* $h0 -841/108) 4/29)))",
        "-707281/11664",
        "(/ $h0 (+ (* $h0 -841/108) 4/29))",
        "(+ (* $h0 -841/108) 4/29)",
        "-841/108",
    ...
    runner = runner.with_node_limit(8000).with_hook(|r| {
