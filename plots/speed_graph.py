...
def plot_speed_graph(outcomes, ax):
    ...
    ax.plot(tool_cmp2speed(baseline_cmp)[0], tool_cmp2speed(baseline_cmp)[1], '.-', linewidth=2.0, color='g',
            label='baseline')
    ax.plot(tool_cmp2speed(rival_cmp)[0], tool_cmp2speed(rival_cmp)[1], '.-', linewidth=2.0, color='r', label='rival')
    ax.plot(tool_cmp2speed(sollya_cmp)[0], tool_cmp2speed(sollya_cmp)[1], '.-', linewidth=2.0, color='b',
            label='sollya')
